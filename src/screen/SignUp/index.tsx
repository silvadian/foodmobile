...
import { Button, Container, Gap, Header, Input, InputAvatar } from '../../components'
  ...
  return (
    <Container style={styles.container}>
      ...
      <View style={styles.form}>
        <Gap height={26} />
        <InputAvatar onPress={() => setShowPicker(true)} uri={uri}></InputAvatar>
      ...
      {showPicker ? (
        <View style={styles.openPicker}>
          ...
          <TouchableOpacity style={{ alignItems: 'flex-end' }} onPress={() => setShowPicker(false)}>
            <ICX />
          </TouchableOpacity>
        </View>
      ) : null}
